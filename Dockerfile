...
RUN pip install git+https://github.com/SharonGoliath/racs2caom2@${PIPE_BRANCH}#egg=racs2caom2
#RUN pip install git+https://github.com/${PIPE_REPO}/racs2caom2@${PIPE_BRANCH}#egg=racs2caom2
